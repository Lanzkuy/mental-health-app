 ...
 * Use the [ConsultationCompletedFragment.newInstance] factory method to
...
class ConsultationCompletedFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ConsultationCompletedFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ConsultationCompletedFragment().apply {
